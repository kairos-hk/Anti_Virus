...
LOGO = r"""
      __      _____  ___  ___________  __             _______    ________  ___      ___ 
     /""\    (\"   \|"  \("     _   ")|" \           |   __ "\  /"       )|"  \    /"  |
    /    \   |.\\   \    |)__/  \\__/ ||  |          (. |__) :)(:   \___/ |\   \  //   |
   /' /\  \  |: \.   \\  |   \\_ /    |:  |          |:  ____/  \___  \   | \   \/.    |
  //  __'  \ |.  \    \. |   |.  |    |.  |          (|  /       __/  \\  |: \.        |
 /   /  \\  \|    \    \ |   \:  |    /\  |\    _   /|__/ \     /" \   :) |.  \    /:  |
(___/    \___)\___|\____\)    \__|   (__\_|_)  |_| (_______)   (_______/  |___|\__/|___|
                                                        My Friend Park SeongMin == Virus  
                                                               Author : github@kairos-hk                                                              
"""
...
def main():
    ...
    if len(sys.argv) < 1:
        ...
        if options.path:
            ...
            print(f'{Bcolors.Green}<---------------Finding SeongMin..--------------->{Bcolors.Endc}')
            check_engine()
